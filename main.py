...
async def restart_handler(_, m):
    ...
    await m.reply_text("**STOPPING**", True)
    os.execl(sys.executable, sys.executable, *sys.argv)



@bot.on_message(filters.command(["GLAD"]))
async def account_login(bot: Client, m: Message):
    logging.info("GLAD....")
    if m.chat.id != grp:
    ...
    editable = await m.reply_text('Send TXT msg/file for download')
